...
cat >>/etc/hosts<<EOF
10.10.100.20   kmaster.example.com     kmaster
10.10.100.21   kworker1.example.com    kworker1
10.10.100.22   kworker2.example.com    kworker2
10.10.100.22   kworker3.example.com    kworker3
EOF
